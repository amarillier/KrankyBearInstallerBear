...
AppId={{55F17CC0-57CC-43E9-A0A4-84C4AAECADE8}
AppName={#MyAppName}
...
OutputBaseFilename=KrankyBearInstallerBearSetup_{#MyAppVersion}
SetupIconFile=..\assets\images\KrankyBearInstallerBear.ico
Compression=lzma
...
Source: "..\assets\images\KrankyBearInstallerBear.ico"; DestDir: "{app}"; Flags: ignoreversion
