...
const (
	...
	updateRepo      = "KrankyBearInstallerBear"
	updateRepoDL    = "https://github.com/amarillier/KrankyBearInstallerBear/releases/latest"
)
...
func showUpdateDialog(a fyne.App, message string, updateAvailable bool, ahead bool) {
	...
	icon := newBrandingDialogImage(resourceKrankyBearInstallerBearPng)
	...
	if updateAvailable {
		releaseURL, _ := url.Parse("https://github.com/amarillier/KrankyBearInstallerBear/releases/latest")
